...
public class CondTermList_list extends CondTermList {

    private CondTermList CondTermList;
    private CondTerm CondTerm;

    public CondTermList_list (CondTermList CondTermList, CondTerm CondTerm) {
    ...
    public String toString(String tab) {
        ...
        buffer.append(tab);
        buffer.append("CondTermList_list(\n");
