...
public class CondFactList_list extends CondFactList {

    private CondFactList CondFactList;
    private CondFact CondFact;

    public CondFactList_list (CondFactList CondFactList, CondFact CondFact) {
    ...
    public String toString(String tab) {
        ...
        buffer.append(tab);
        buffer.append("CondFactList_list(\n");
