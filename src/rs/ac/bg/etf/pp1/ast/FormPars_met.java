...
public class FormPars_met extends FormPars {

    private FormParsVarArray FormParsVarArray;
    private FormParsVarArrayNext FormParsVarArrayNext;

    public FormPars_met (FormParsVarArray FormParsVarArray, FormParsVarArrayNext FormParsVarArrayNext) {
